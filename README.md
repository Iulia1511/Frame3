...
* Обновите соответствующие представления для отображения списка задач и отдельной задачи.

![image](https://github.com/user-attachments/assets/e657f5a7-0c82-4ec4-8da3-cc6f1f7f7eb6)

![image](https://github.com/user-attachments/assets/0697fa83-7d89-4909-8649-8349a92edd3e)

* Обновите метод create для отображения формы создания задачи и метод store для сохранения новой задачи в базе данных.

  ![image](https://github.com/user-attachments/assets/b7ba13cd-14dc-4600-b36a-be575ce7db72)

* Обновите метод edit для отображения формы редактирования задачи и метод update для сохранения изменений в базе данных.

  ![image](https://github.com/user-attachments/assets/91b50c18-4f22-4c13-8c27-631fd14fb794)

![image](https://github.com/user-attachments/assets/07cdf8b2-2607-41ff-8143-f90394c68a75)

* Обновите метод destroy для удаления задачи из базы данных.4

![image](https://github.com/user-attachments/assets/e710cdc7-3e90-446a-a169-5dfb99db5fbb)

## Контрольные вопросы
* Что такое миграции и для чего они используются?
Миграции — это механизм в Laravel для версионного контроля схемы базы данных, позволяющий создавать, изменять и удалять таблицы с помощью кода.

* Что такое фабрики и сиды, и как они упрощают процесс разработки и тестирования?
Фабрики позволяют генерировать тестовые данные для моделей, а сиды заполняют базу данных этими данными, упрощая разработку и тестирование.

* Что такое ORM? В чем различия между паттернами DataMapper и ActiveRecord?
ORM (Object-Relational Mapping) — это способ работы с базой данных через объекты. ActiveRecord связывает модель с таблицей напрямую, а DataMapper отделяет логику модели от базы данных.

* В чем преимущества использования ORM по сравнению с прямыми SQL-запросами?
ORM упрощает работу с БД, улучшает читаемость кода, защищает от SQL-инъекций и делает код независимым от конкретного типа базы данных.

* Что такое транзакции и зачем они нужны при работе с базами данных?
Транзакции — это механизм, позволяющий группировать SQL-операции и выполнять их атомарно, предотвращая частичные изменения данных в случае ошибки.
